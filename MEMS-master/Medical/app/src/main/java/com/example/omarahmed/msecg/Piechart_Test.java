...
public class Piechart_Test extends AppCompatActivity implements OnChartValueSelectedListener,OnChartGestureListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        PieDataSet dataSet = new PieDataSet(yvalues, "SElected Mode");

        ArrayList<String> xVals = new ArrayList<String>();


        xVals.add(String.valueOf("Walking"));
        xVals.add(String.valueOf("Sleeping"));
        xVals.add(String.valueOf("Running"));
