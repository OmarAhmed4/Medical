...
public class After_Connection_to_Bluetooth extends AppCompatActivity  implements OnChartValueSelectedListener,OnChartGestureListener {
    ...
    private String[] leads_name= new String[]{"100","80","60"};
    private String[] mode=new String[]{"Running","Walking","Sleeping"};
       ...
       /* Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                String s=Integer.toString(progress+40);
                connectedThread.write(s.getBytes());
            }

            //(leads_name[e.getXIndex()]).getBytes()
        ...
        ArrayList<String> xVals = new ArrayList<String>();
            ...
            xVals.add(String.valueOf("ٌRunning"));
        xVals.add(String.valueOf("ٌWalking"));
        xVals.add(String.valueOf("ٌSleeping"));
...
// TODO :   Line Chart
    ...
    public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
        ...
        Toast t=Toast.makeText(getApplicationContext(),"Selected Mode is : "+ mode[e.getXIndex()] ,Toast.LENGTH_SHORT);
        t.show();
        SeekBar seekBar= (SeekBar) findViewById(R.id.simpleSeekBar);
        seekBar.setProgress(Integer.parseInt(leads_name[e.getXIndex()])-40);
        /*connectedThread=new ConnectedThread(bluetoothSocket);
        connectedThread.start();
        connectedThread.write((leads_name[e.getXIndex()]).getBytes());
*/
